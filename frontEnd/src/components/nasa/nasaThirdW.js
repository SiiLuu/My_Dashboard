...
export const NasaThird = props => {
    ...
    (date) => {
      ...
      fetch("http://localhost:5000/api/subscribe/subscribe_list", {
        ...
        res.json().then((data) => {
          ...
          fetch("https://api.nasa.gov/mars-photos/api/v1/rovers/opportunity/photos?earth_date=" + date + "&api_key=" + API_KEY, {
            method: "GET",
            headers: {
              'Accept': 'application/json'
            },
  ...
  return (
    <div className="nasaThird">
      <div className="top">
        <img alt={title} src={APIicon} />
        <h1>Opportunity Photos</h1>
        <div className="butt">
